...
def elegirTest(opcion):
    ...
    mensaje= Label(raiz, text="Haga clic en el teste que desea abrir",font="arial 20").place(x=300,y=20)
    t1 = Button(raiz, text="Test 1",font="arial 18",command=lambda: mostrartest(opcion,1)).place(x=400,y=100)
    t2 = Button(raiz, text="Test 2",font="arial 18",command=lambda: mostrartest(opcion,2)).place(x=400,y=200)

    t3 = Button(raiz, text="Test 3",font="arial 18",command=lambda: mostrartest(opcion,3)).place(x=400,y=300)
    t4 = Button(raiz, text="Test 4",font="arial 18",command=lambda: mostrartest(opcion,4)).place(x=400,y=400)
    t5 = Button(raiz, text="Test 5",font="arial 18",command=lambda: mostrartest(opcion,5)).place(x=400,y=500)
